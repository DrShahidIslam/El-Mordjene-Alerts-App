"""
RSS Feed Monitor — Fetches and filters food/recipe/dessert stories from curated RSS feeds.
"""
import feedparser
import hashlib
import logging
...
def _matches_keywords(text, keywords=None):
    """Check if text matches any food/recipe related keywords."""
    if keywords is None:
...
def fetch_rss_stories():
    ...
    # Exclusion filter — remove unrelated topics
